...
![The forge, up close](../../assets/posts/the-forge/cover-photo.jpeg)

Several images in one paragraph become a row. Paths can be copied straight from the CMS media browser:

![The anvil](src/assets/posts/the-forge/anvil-up-close.jpeg) ![Forge on a table](src/assets/posts/the-forge/forge-on-a-table.jpeg)
